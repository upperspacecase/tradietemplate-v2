...
function ReviewCard({ review }) {
    return (
        <div
            className="flex-shrink-0 w-[300px] sm:w-[340px] bg-white rounded-lg border border-[#e8e8e8] p-5"
        ...
        <section id="reviews" className="bg-white py-16 sm:py-20 lg:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="lg:w-[240px] flex-shrink-0">
                        <div className="lg:sticky lg:top-24 text-center lg:text-left">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 bg-[#4285F4] hover:bg-[#3367d6] text-white text-sm font-medium px-5 py-2.5 rounded-full transition-colors"
                            >
                                <GoogleIcon />
                                Review us on Google
                            </a>
                    ...
                    {/* Right panel — Review cards carousel */}
