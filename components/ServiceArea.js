        ...
        <section id="service-area" className="bg-surface py-16 sm:py-20 lg:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="rounded-2xl overflow-hidden border border-sky-100 aspect-[4/3]">
                        <iframe
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-x-6 gap-y-2">
                            {serviceArea.suburbs.map((suburb, i) => (
                                <p key={i} className="text-text-muted text-sm py-1.5 border-b border-sky-50">
                                    {suburb}
                                </p>
                            ))}
                        </div>
                        <p className="mt-6 text-sm text-text-light">
                            Don&apos;t see your suburb? Give us a call — we likely cover your area too.
                        </p>
                    </div>
                </div>
            </div>
